# uView-select
基于uView组件库的二次封装下拉组件
## github地址:[https://github.com/1205093639/uView-select](https://github.com/1205093639/uView-select)
放入项目中的components中使用 demo :` <mySelect :list="下拉列表" v-model="绑定值"  type="action"></mySelect>`
## 效果图
### action操作菜单

![在这里插入图片描述](https://img-blog.csdnimg.cn/5695602060764563b7b273e95e3f175b.png)

### picker滚动选择框
![在这里插入图片描述](https://img-blog.csdnimg.cn/7f641bf83c5941aea118aaac3efab017.png)
### checkbox多选
![在这里插入图片描述](https://img-blog.csdnimg.cn/a60db094a27d4d5ab7b34cf485a3410b.png)
### search搜索选择框
![在这里插入图片描述](https://img-blog.csdnimg.cn/beda8797daba4b03a769e6ecd76434db.png)
### scan扫码验证框
![在这里插入图片描述](https://img-blog.csdnimg.cn/4d279dec75a14a39a5e80f0831a4c166.png)
## 属性事件
|         属性| 说明|
|--|--|
|   disabled  | 是否禁用|
